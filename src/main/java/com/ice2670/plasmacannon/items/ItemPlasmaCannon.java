...
public class ItemPlasmaCannon extends ItemBase
{
    public ItemPlasmaCannon(String name) {
        super(name);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player,
        ...
        itemInformation.add(TextFormatting.ITALIC + "" + TextFormatting.BLUE + I18n
                .format("tooltip.plasmacannons.item_plasmacannon_1"));
        itemInformation.add(TextFormatting.ITALIC + "" + TextFormatting.BLUE + I18n
                .format("tooltip.plasmacannons.item_plasmacannon_2"));
        itemInformation.add(TextFormatting.RED + "" + TextFormatting.ITALIC + I18n
                .format("tooltip.plasmacannons.item_plasmacannon_3"));
    }
}
