package com.ice2670.plasmacannon.util;
...
public class Reference
{
    ...
    public static final int ENTITY_PLASMABALL = 120;
    public static final int ENTITY_lARGEPLASMABALL = 121;
    public static final int FAKE_ENTITY_lARGEPLASMABALL = 122;
    public static final int FAST_TORPEDO = 123;
    public static final int FAKE_TORPEDO = 124;
    public static final int AUTO_TORPEDO = 125;
    public static final int FAKE_AUTOTORPEDO = 126;
