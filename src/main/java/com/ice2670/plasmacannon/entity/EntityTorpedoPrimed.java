...
public class EntityTorpedoPrimed extends Entity
{
    ...
    public EntityTorpedoPrimed(World worldIn)
    {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTorpedoPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter, int power)
    {
        this(worldIn);
    ...
    {
        this.world.createExplosion(this, this.posX, this.posY + (double)(this.height / 16.0F), this.posZ, this.power, true);
    }
