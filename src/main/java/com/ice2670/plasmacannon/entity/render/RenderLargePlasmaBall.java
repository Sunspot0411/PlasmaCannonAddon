...
{
    private static final ResourceLocation INVULNERABLE_WITHER_TEXTURES = new ResourceLocation("textures/blocks/concrete_light_blue.png");
    private static final ResourceLocation WITHER_TEXTURES = new ResourceLocation("textures/blocks/concrete_light_blue.png");
    ...
    public void doRender(EntityLargePlasmaBall entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.skeletonHeadModel.render(entity, 0.0F, 0.0F, 0.0F, f, f1, 0.11F);
