...
public class RenderEntityTorpedoPrimed extends Render<EntityTorpedoPrimed>
{

    public RenderEntityTorpedoPrimed(RenderManager renderManagerIn)
    {
    ...
    public void doRender(EntityTorpedoPrimed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityTorpedoPrimed entity)
    {
